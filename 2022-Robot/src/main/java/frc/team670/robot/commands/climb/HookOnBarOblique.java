 ...
 */
public class HookOnBarOblique extends CommandBase implements MustangCommand {
    ...
    public void execute() {
        if (!hooked || !hooked2) {
            climber.hookOnBarOblique();
        }
    }

    @Override
    public boolean isFinished() {
        return climber.isHookedOnBarOblique() && climber.isHookedOnBarOblique2();
    }
