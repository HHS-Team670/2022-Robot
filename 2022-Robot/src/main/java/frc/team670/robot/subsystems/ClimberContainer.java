...
public class ClimberContainer {
   ...
   // SmartMotion constants 
    ...
    private static final double VERTICAL_MAX_ACC = 200; // TODO test
    private static final double VERTICAL_MIN_VEL = 0; // TODO test
    private static final double VERTICAL_MAX_VEL = 200; // TODO test
    ...
    public static ArrayList<Climber> getClimbers() {
        ...
        Climber verticalClimber = new Climber(RobotMap.VERTICAL_CLIMBER, VERTICAL_kFF,
        ...
        Climber diagonalClimber = new Climber(RobotMap.DIAGONAL_CLIMBER, DIAGONAL_kFF,
